...
class BertForPhraseSim(BertForSequenceClassification):
    """
    Bert For Phrase similarity Task
    """
    def __init__(self, config, params):
        super(BertForPhraseSim, self).__init__(config, params['n_labels'])
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None, labels=None):
        ...
        logging.debug('bert phrase sim: pooled_output shape {}'.format(pooled_output.shape))
        ...
        logging.debug('bert phrase sim: logits {}'.format(self.logits.shape))
        return self.logits
    ...
    #     logging.info('bert phrase sim: prediction_result {}'.format(self.prediction_result.shape))
