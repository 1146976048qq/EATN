...
class Instructor:
    ...
    def run(self):
        ...
        logger.info('>> time_spend: {}'.format(time_spend))
   ...
   # parser.add_argument('--pretrained_bert_name', default=None, type=str)
    ...
    dataset_files = {
        ...
        'twitter-t2r': {
            #'train': './datasets/acl-14-short-data/train.raw',
            #'test': './datasets/acl-14-short-data/test.raw'
            'train': './datasets/acl-14-short-data/train_kkzhang.raw',
...
####################### aspect category ###########################
        ...
        'beautyspa': {
            'train': './datasets/aspect_category/beautyspa/beautyspa_train.txt',
            'test': './datasets/aspect_category/beautyspa/beautyspa_test.txt'        
        },
        'hotel': {
            'train': './datasets/aspect_category/hotel/hotel_train.txt',
            'test': './datasets/aspect_category/hotel/hotel_test.txt'
        },
        'restaurant_c': {
             'train': './datasets/aspect_category/restaurant/restaurant_train.txt',
             'test': './datasets/aspect_category/restaurant/restaurant_test.txt' 
        },

########################################################### cross ########
        'beautyspa_b2h': {
            'train': './datasets/aspect_category/beautyspa/beautyspa_all.txt',
            'test': './datasets/aspect_category/hotel/hotel_all.txt'        
        },

        'beautyspa_b2r': {
            'train': './datasets/aspect_category/beautyspa/beautyspa_all.txt',
            'test': './datasets/aspect_category/restaurant/restaurant_all.txt'        
        },
##########################
        'hotel_h2b': {
            'train': './datasets/aspect_category/hotel/hotel_all.txt',
            'test': './datasets/aspect_category/beautyspa/beautyspa_all.txt'
        }, 
       'hotel_h2r': {
            'train': './datasets/aspect_category/hotel/hotel_all.txt',
            'test': './datasets/aspect_category/restaurant/restaurant_all.txt'
...
##########################
        'restaurant_c_r2b': {
             'train': './datasets/aspect_category/restaurant/restaurant_all.txt',
             'test': './datasets/aspect_category/beautyspa/beautyspa_all.txt' 
        },
        'restaurant_c_r2h': {
             'train': './datasets/aspect_category/restaurant/restaurant_all.txt',
